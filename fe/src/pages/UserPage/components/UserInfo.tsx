...
const UserInfo = () => {
  ...
  const modalClass = clsx(
    "bg-quaternary w-[550px] h-fit p-5 rounded flex flex-col gap-3 text-primary",
    visibleForm
    ...
    <div className="flex flex-col w-3/4 gap-5 p-5">
      ...
      <div>
        ...
        {visibleForm && (
          <div
            id="update-form"
            className="fixed top-0 left-0 z-10 flex content-center justify-center w-full h-screen overflow-hidden bg-opacity-50 bg-primary"
          >
